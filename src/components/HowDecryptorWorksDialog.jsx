    ...
    >
      ...
      <DialogContent dividers>
        <Box sx={{ p: 2 }}>
          ...
          <Typography>
            Rahasya(Sanskrit: रहस्य, means secret, mystery, or something hidden)
            Decryptor allows you to securely access your encrypted secrets. It
            requires the same master key that was used for encryption, and if
            AAD was used, you&apos;ll need that value as well.
          </Typography>
          <Divider sx={{ my: 2 }} />
          ...
          <Box sx={{ mb: 3 }}>
            ...
            <List dense>
              <ListItem>
                <ListItemText secondary="1. Click the decrypt button next to any secret" />
              </ListItem>
              <ListItem>
                <ListItemText secondary="2. View the decrypted username, password, and notes" />
              </ListItem>
              <ListItem>
                <ListItemText secondary="3. Copy values to clipboard as needed" />
              </ListItem>
              <ListItem>
                <ListItemText secondary="4. Secret is automatically hidden when dialog is closed" />
              </ListItem>
            </List>
          </Box>
          ...
          <Box sx={{ mb: 3 }}>
            ...
            <List dense>
              <ListItem>
                <ListItemText secondary="1. Add your master key" />
              </ListItem>
              <ListItem>
                <ListItemText secondary="2. Upload the .rahasya file" />
              </ListItem>
              <ListItem>
                <ListItemText secondary="3. Click decrypt button next to each secret you want to view" />
              </ListItem>
              <ListItem>
                <ListItemText secondary="4. Copy needed information" />
              </ListItem>
            </List>
            ...
            <List dense>
              <ListItem>
                <ListItemText secondary="1. Add master key" />
              </ListItem>
              <ListItem>
                <ListItemText secondary="2. Upload encrypted file" />
              </ListItem>
              <ListItem>
                <ListItemText secondary="3. Provide AAD value when decrypting secrets" />
              </ListItem>
              <ListItem>
                <ListItemText secondary="4. View decrypted information" />
              </ListItem>
            </List>
            ...
            <List dense>
              <ListItem>
                <ListItemText secondary="• Accessing stored passwords" />
              </ListItem>
              <ListItem>
                <ListItemText secondary="• Retrieving secure notes" />
              </ListItem>
              <ListItem>
                <ListItemText secondary="• Viewing encrypted credentials" />
              </ListItem>
            </List>
          </Box>
          ...
          >
            ...
            <List dense sx={{ pl: 1 }}>
              <ListItem>
                <Typography variant="body2" color="warning.dark">
                  • <strong>Master Key Match:</strong> The master key must
                  exactly match the one used during encryption. There is no way
                  to recover data if you use a different key.
                </Typography>
              </ListItem>
              <ListItem>
                <Typography variant="body2" color="warning.dark">
                  • <strong>AAD Requirement:</strong> If AAD was used during
                  encryption, you must provide the same AAD value for
                  decryption.
                </Typography>
              </ListItem>
              <ListItem>
                <Typography variant="body2" color="warning.dark">
                  • <strong>Offline Security:</strong> All decryption happens
            ...
            >
              ⚠️ NO RECOVERY OPTIONS: If you&apos;ve forgotten your master key
              or AAD value, there is absolutely no way to recover your encrypted
              data!
            </Typography>
          </Box>
        </Box>
