        ...
        >
            ...
            <DialogContent dividers>
                <Box sx={{ p: 2 }}>
                    ...
                    <Typography>
                        Rahasya(Sanskrit: रहस्य, <i>means secret, mystery, or something hidden</i>) is a secure tool for managing and encrypting sensitive information 
                        like passwords, credentials, and secrets. It works completely offline, 
                    ...
                    <Box sx={{ mb: 3 }}>
                        ...
                        <List dense>
                            <ListItem>
                                <ListItemText 
                                    secondary="1. Click 'Generate New File' after setting master key"
                                />
                            </ListItem>
                            <ListItem>
                                <ListItemText 
                                    secondary="2. Add secrets (Title, Username, Password, Notes)"
                                />
                            </ListItem>
                            <ListItem>
                                <ListItemText 
                                    secondary="3. File is automatically encrypted and ready for download"
                                />
                            </ListItem>
                        </List>
                        ...
                        <List dense>
                            <ListItem>
                                <ListItemText 
                                    secondary="1. Click 'Upload File' and enter master key"
                                />
                            </ListItem>
                            <ListItem>
                                <ListItemText 
                                    secondary="2. View and manage existing secrets"
                                />
                            </ListItem>
                            <ListItem>
                                <ListItemText 
                                    secondary="3. Download updated file after changes"
                                />
                            </ListItem>
                        </List>
                    </Box>
                    ...
                    <Box sx={{ mb: 3 }}>
                        ...
                        <List dense>
                            ...
                            <ListItem sx={{ pl: 4 }}>
                                <ListItemText 
                                    secondary="• When enabled, prevents encrypted data from being used in different contexts"
                                />
                            </ListItem>
                            <ListItem sx={{ pl: 4 }}>
                                <ListItemText 
                                    secondary="• Provides additional integrity and authenticity verification"
                                />
                            </ListItem>
                            <ListItem sx={{ pl: 4 }}>
                                <ListItemText 
                                    secondary="• Optional but recommended for enhanced security"
                                />
                            </ListItem>
                        </List>
                    </Box>
                    ...
                    <Box sx={{ 
                        ...
                        <List dense sx={{ pl: 1 }}>
                            <ListItem>
                                <Typography variant="body2" color="warning.dark">
                                    • <strong>Master Key:</strong> If you forget or lose your master key, 
                                    there is NO WAY to recover your encrypted data. Keep your master key 
                                    in a secure location!
                                </Typography>
                            </ListItem>
                            <ListItem>
                                <Typography variant="body2" color="warning.dark">
                                    • <strong>AAD (Additional Authenticated Data):</strong> If you enable AAD, 
                                    you must remember both the master key AND the AAD value. Without either, 
                                    your data cannot be decrypted.
                                </Typography>
                            </ListItem>
                            <ListItem>
                                <Typography variant="body2" color="warning.dark">
                                    • <strong>Data Security:</strong> The encryption includes additional 
                                    safeguards to protect against tampering and unauthorized modifications.
                                </Typography>
                            </ListItem>
                            <ListItem>
                                <Typography variant="body2" color="warning.dark">
                                    • <strong>Offline Usage:</strong> You can use Rahasya offline - save it 
                                    to your device for secure access without internet connectivity.
                                </Typography>
                            </ListItem>
                        </List>
                        <Typography 
                        ...
                        >
                            ⚠️ NO RECOVERY OPTIONS: There is no way to recover encrypted data if you lose 
                            your master key or AAD (if enabled). Make sure to keep them secure!
                        </Typography>
                    </Box>
                </Box>
            </DialogContent>
